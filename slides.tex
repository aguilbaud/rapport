...
\begin{frame}
  ...
  \visible<2->{
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
      ...
      \hline
      ... & $\frac{\partial u}{\partial x}_{i-3}$ & $\frac{\partial u}{\partial x}_{i-2}$ & $\only<4->{\cellcolor{red!70}}\frac{\partial u}{\partial x}_{i-1}$ & \cellcolor{green} $\frac{\partial u}{\partial x}_{i}$ & $\only<4->{\cellcolor{red!70}}\frac{\partial u}{\partial x}_{i+1}$ & $\frac{\partial u}{\partial x}_{i+2}$ & $\frac{\partial u}{\partial x}_{i+3}$  & ... \\
      \hline
  \end{tabular}}
...
\begin{frame}
  ...
  \centering
  \only<1>{Communications sur $x$\\}
  \only<2>{Synchronisation\\}
  \only<3>{Communications sur $y$\\}
  \only<4>{État après les communications\\}
  \only<1>{\includegraphics[scale=0.3]{slide_overlapcom_1.png}\\}
  \only<2>{\includegraphics[scale=0.3]{slide_overlapcom_2.png}\\}
  \only<3>{\includegraphics[scale=0.3]{slide_overlapcom_3.png}\\}
  \only<4>{\includegraphics[scale=0.3]{slide_overlapcom_4.png}}
\end{frame}
