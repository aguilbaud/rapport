...
\begin{frame}
  ...
  \end{itemize}
	\centering
	\visible<2->{\includegraphics[scale=0.2]{regular-mesh.png}}
	\visible<2->{\includegraphics[scale=0.2]{irregular-mesh.png}}
\end{frame}
...
\end{tabular}
\only<2>{$$u$$\includegraphics[scale=0.3]{slide_deriv_1.png}$$\frac{\partial u}{\partial x}$$}
\only<3>{\includegraphics[scale=0.3]{slide_deriv_2.png}}
