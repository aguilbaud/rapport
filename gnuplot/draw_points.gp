...
set title "Number of overlapping points\n{/*0.7  Overlap 6 - 400^3}"

plot 'points'  u 1:2:3 w filledcu lc rgbcolor green_025  t column,'' u 1:(f($1)):3 w filledcu t column(3) lc rgbcolor blue_025
